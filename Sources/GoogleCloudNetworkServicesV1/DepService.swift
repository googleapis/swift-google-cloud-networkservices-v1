  ...
  public func createLbTrafficExtension(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try LbTrafficExtension(fromAny: anyValueUnwrapped)
  ...
  public func createLbRouteExtension(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try LbRouteExtension(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createLbEdgeExtension(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try LbEdgeExtension(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createAuthzExtension(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try AuthzExtension(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
